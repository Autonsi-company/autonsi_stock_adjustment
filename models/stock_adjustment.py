...
class StockAdjustmentOrder(models.Model):
    ...
    location_id = fields.Many2one("stock.location", "Area", domain=([('location_type', 'not in', ['rack', 'bin'])]))
...
class StockCheckOrder(models.Model):
    ...
    location_id = fields.Many2one("stock.location", "Rack", domain=([('location_type', '=', 'rack')]))
